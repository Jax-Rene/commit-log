...
**核心目标:** 构建一个能用的、具备核心 AI 亮点的、可作为摄影集展示的技术博客。

**MVP 功能清单:**
- **核心模块:**
    - [x] **专业博客 (Blog):** 文章的完整 CRUD 功能。
    - [x] **动态简历 (About Me):** 可后台编辑的“About Me”页面。
- **后台管理:**
    - [x] **统一后台:** 桌面端优先。
...
### 1.2. 核心目标
本项目旨在成为作者作为 **AI 全栈工程师** 的核心摄影集 (Showcase)，全面展示其在产品设计、前后端开发、AI 功能集成、DevOps 及用户体验优化等方面的综合能力。
