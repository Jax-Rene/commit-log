# 个人成长与展示平台 V3 - 产品需求文档 (PRD)

## 0. 版本定位与目标

### 0.1 背景
- V1 已交付博客 CRUD、后台 Markdown 编辑、关于我页面等基础能力。
- V2 完成了习惯管理工作流、关于我页前台展示及 Fly.io 生产部署，但仍有部分体验与工程化事项未落实。
...
* [ ] 编辑器内支持 **AI 划词改写**
* [ ] 支持“幽默化/口语化/专业化”等可选改写风格
* [ ] 编辑器支持 **全文优化** 功能（优化前可预览）
* [ ] 支持 OpenAI API Key 配置
* [ ] 发布文章时自动生成 AI 摘要
* [ ] 自动摘要用于：文章列表卡片、副标题、SEO meta description
* [ ] 生成结果可手动编辑
* [ ] 失败时兜底提示（支持重试）
...
* [ ] 替换 EasyMD → TipTap / Editor.js
* [ ] 支持 Markdown 导入与导出（Round-trip 不丢失格式）
* [ ] 支持 Zen Mode（全屏沉浸写作）
* [ ] 支持实时预览
* [ ] 图片上传功能可用
* [ ] 支持代码高亮（多语言）
...
* [ ] 接入 JSON 结构化日志
* [ ] 每个请求包含 trace_id、用户信息、耗时
* [ ] 搭建日志 Dashboard（按天查看核心指标）
* [ ] 支持查询指定请求全链路信息
